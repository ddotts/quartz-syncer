...
- **Publish-time customization**: Route notes with `publish: key/folder` or `publish: key/root`, remove source-only Markdown blocks, and rewrite published frontmatter tags with regex rules.
